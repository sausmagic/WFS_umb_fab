    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractCurveType> theCurve;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            JAXBElement<? extends AbstractCurveType> lhsCurve;
            lhsCurve = this.getCurve();
            JAXBElement<? extends AbstractCurveType> rhsCurve;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CurvePropertyType) {
            ...
            if (this.isSetCurve()) {
                JAXBElement<? extends AbstractCurveType> sourceCurve;
                sourceCurve = this.getCurve();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractCurveType> copyCurve = ((JAXBElement<? extends AbstractCurveType> ) strategy.copy(LocatorUtils.property(locator, "curve", sourceCurve), sourceCurve));
                copy.setCurve(copyCurve);
            } else {
                copy.curve = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof CurvePropertyType) {
            ...
            final CurvePropertyType rightObject = ((CurvePropertyType) right);
            {
                ...
                target.setCurve(((JAXBElement<? extends AbstractCurveType> ) strategy.merge(LocatorUtils.property(leftLocator, "curve", lhsCurve), LocatorUtils.property(rightLocator, "curve", rhsCurve), lhsCurve, rhsCurve)));
            }
            {
                String lhsRemoteSchema;

 ...
 * 
 * <p>Java-Klasse für TransformationRefType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TransformationRefType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final TransformationRefType that = ((TransformationRefType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TransformationRefType) {
            final TransformationRefType copy = ((TransformationRefType) draftCopy);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof TransformationRefType) {
            final TransformationRefType target = this;
            final TransformationRefType leftObject = ((TransformationRefType) left);
            final TransformationRefType rightObject = ((TransformationRefType) right);
            {
                TransformationType lhsTransformation;

 ...
 * 
 * <p>Java-Klasse für CartesianCSRefType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CartesianCSRefType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CartesianCSRefType that = ((CartesianCSRefType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CartesianCSRefType) {
            final CartesianCSRefType copy = ((CartesianCSRefType) draftCopy);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof CartesianCSRefType) {
            final CartesianCSRefType target = this;
            final CartesianCSRefType leftObject = ((CartesianCSRefType) left);
            final CartesianCSRefType rightObject = ((CartesianCSRefType) right);
            {
                CartesianCSType lhsCartesianCS;

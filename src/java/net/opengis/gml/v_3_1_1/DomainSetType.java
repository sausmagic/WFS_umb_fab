...
public class DomainSetType implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der timeObject-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der timeObject-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link TimeEdgeType }{@code >}
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            JAXBElement<? extends AbstractTimeObjectType> theTimeObject;
            theTimeObject = this.getTimeObject();
            strategy.appendField(locator, this, "timeObject", buffer, theTimeObject);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            JAXBElement<? extends AbstractTimeObjectType> lhsTimeObject;
            lhsTimeObject = this.getTimeObject();
            JAXBElement<? extends AbstractTimeObjectType> rhsTimeObject;
            rhsTimeObject = that.getTimeObject();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "timeObject", lhsTimeObject), LocatorUtils.property(thatLocator, "timeObject", rhsTimeObject), lhsTimeObject, rhsTimeObject)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            JAXBElement<? extends AbstractTimeObjectType> theTimeObject;
            theTimeObject = this.getTimeObject();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "timeObject", theTimeObject), currentHashCode, theTimeObject);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof DomainSetType) {
            ...
            if (this.isSetTimeObject()) {
                JAXBElement<? extends AbstractTimeObjectType> sourceTimeObject;
                sourceTimeObject = this.getTimeObject();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractTimeObjectType> copyTimeObject = ((JAXBElement<? extends AbstractTimeObjectType> ) strategy.copy(LocatorUtils.property(locator, "timeObject", sourceTimeObject), sourceTimeObject));
                copy.setTimeObject(copyTimeObject);
            } else {
                copy.timeObject = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof DomainSetType) {
            ...
            final DomainSetType rightObject = ((DomainSetType) right);
            {
                ...
                target.setGeometry(((JAXBElement<? extends AbstractGeometryType> ) strategy.merge(LocatorUtils.property(leftLocator, "geometry", lhsGeometry), LocatorUtils.property(rightLocator, "geometry", rhsGeometry), lhsGeometry, rhsGeometry)));
            }
            {
                JAXBElement<? extends AbstractTimeObjectType> lhsTimeObject;
                lhsTimeObject = leftObject.getTimeObject();
                JAXBElement<? extends AbstractTimeObjectType> rhsTimeObject;
                rhsTimeObject = rightObject.getTimeObject();
                target.setTimeObject(((JAXBElement<? extends AbstractTimeObjectType> ) strategy.merge(LocatorUtils.property(leftLocator, "timeObject", lhsTimeObject), LocatorUtils.property(rightLocator, "timeObject", rhsTimeObject), lhsTimeObject, rhsTimeObject)));
            }
            {
                String lhsRemoteSchema;

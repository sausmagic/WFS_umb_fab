...
/**
 * <p>Java-Klasse für TopologyStylePropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der topologyStyle-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der topologyStyle-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link TopologyStyleType }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            TopologyStyleType theTopologyStyle;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TopologyStylePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final TopologyStylePropertyType that = ((TopologyStylePropertyType) object);
        {
            TopologyStyleType lhsTopologyStyle;
            lhsTopologyStyle = this.getTopologyStyle();
            TopologyStyleType rhsTopologyStyle;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TopologyStylePropertyType) {
            final TopologyStylePropertyType copy = ((TopologyStylePropertyType) draftCopy);
            if (this.isSetTopologyStyle()) {
                TopologyStyleType sourceTopologyStyle;
                sourceTopologyStyle = this.getTopologyStyle();
                TopologyStyleType copyTopologyStyle = ((TopologyStyleType) strategy.copy(LocatorUtils.property(locator, "topologyStyle", sourceTopologyStyle), sourceTopologyStyle));
                copy.setTopologyStyle(copyTopologyStyle);
            } else {
                copy.topologyStyle = null;
            }
            if (this.isSetAbout()) {
                String sourceAbout;
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof TopologyStylePropertyType) {
            final TopologyStylePropertyType target = this;
            final TopologyStylePropertyType leftObject = ((TopologyStylePropertyType) left);
            final TopologyStylePropertyType rightObject = ((TopologyStylePropertyType) right);
            {
                TopologyStyleType lhsTopologyStyle;
                lhsTopologyStyle = leftObject.getTopologyStyle();
                TopologyStyleType rhsTopologyStyle;
                rhsTopologyStyle = rightObject.getTopologyStyle();
                target.setTopologyStyle(((TopologyStyleType) strategy.merge(LocatorUtils.property(leftLocator, "topologyStyle", lhsTopologyStyle), LocatorUtils.property(rightLocator, "topologyStyle", rhsTopologyStyle), lhsTopologyStyle, rhsTopologyStyle)));
            }
            {
                String lhsAbout;

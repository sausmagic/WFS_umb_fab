 ...
 * 
 * <p>Java-Klasse für VerticalCRSRefType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof VerticalCRSRefType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final VerticalCRSRefType that = ((VerticalCRSRefType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof VerticalCRSRefType) {
            final VerticalCRSRefType copy = ((VerticalCRSRefType) draftCopy);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof VerticalCRSRefType) {
            final VerticalCRSRefType target = this;
            final VerticalCRSRefType leftObject = ((VerticalCRSRefType) left);
            final VerticalCRSRefType rightObject = ((VerticalCRSRefType) right);
            {
                VerticalCRSType lhsVerticalCRS;

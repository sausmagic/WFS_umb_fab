    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der timePrimitive-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der timePrimitive-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link TimeEdgeType }{@code >}
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractTimePrimitiveType> theTimePrimitive;
            theTimePrimitive = this.getTimePrimitive();
            strategy.appendField(locator, this, "timePrimitive", buffer, theTimePrimitive);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            JAXBElement<? extends AbstractTimePrimitiveType> lhsTimePrimitive;
            lhsTimePrimitive = this.getTimePrimitive();
            JAXBElement<? extends AbstractTimePrimitiveType> rhsTimePrimitive;
            rhsTimePrimitive = that.getTimePrimitive();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "timePrimitive", lhsTimePrimitive), LocatorUtils.property(thatLocator, "timePrimitive", rhsTimePrimitive), lhsTimePrimitive, rhsTimePrimitive)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractTimePrimitiveType> theTimePrimitive;
            theTimePrimitive = this.getTimePrimitive();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "timePrimitive", theTimePrimitive), currentHashCode, theTimePrimitive);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TimePrimitivePropertyType) {
            ...
            if (this.isSetTimePrimitive()) {
                JAXBElement<? extends AbstractTimePrimitiveType> sourceTimePrimitive;
                sourceTimePrimitive = this.getTimePrimitive();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractTimePrimitiveType> copyTimePrimitive = ((JAXBElement<? extends AbstractTimePrimitiveType> ) strategy.copy(LocatorUtils.property(locator, "timePrimitive", sourceTimePrimitive), sourceTimePrimitive));
                copy.setTimePrimitive(copyTimePrimitive);
            } else {
                copy.timePrimitive = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof TimePrimitivePropertyType) {
            ...
            {
                JAXBElement<? extends AbstractTimePrimitiveType> lhsTimePrimitive;
                lhsTimePrimitive = leftObject.getTimePrimitive();
                JAXBElement<? extends AbstractTimePrimitiveType> rhsTimePrimitive;
                rhsTimePrimitive = rightObject.getTimePrimitive();
                target.setTimePrimitive(((JAXBElement<? extends AbstractTimePrimitiveType> ) strategy.merge(LocatorUtils.property(leftLocator, "timePrimitive", lhsTimePrimitive), LocatorUtils.property(rightLocator, "timePrimitive", rhsTimePrimitive), lhsTimePrimitive, rhsTimePrimitive)));
            }
            {
                String lhsRemoteSchema;

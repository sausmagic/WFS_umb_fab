    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            JAXBElement<? extends AbstractSurfaceType> lhsSurface;
            lhsSurface = this.getSurface();
            JAXBElement<? extends AbstractSurfaceType> rhsSurface;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof SurfacePropertyType) {
            ...
            if (this.isSetSurface()) {
                JAXBElement<? extends AbstractSurfaceType> sourceSurface;
                sourceSurface = this.getSurface();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractSurfaceType> copySurface = ((JAXBElement<? extends AbstractSurfaceType> ) strategy.copy(LocatorUtils.property(locator, "surface", sourceSurface), sourceSurface));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof SurfacePropertyType) {
            ...
            final SurfacePropertyType rightObject = ((SurfacePropertyType) right);
            {
                ...
                target.setSurface(((JAXBElement<? extends AbstractSurfaceType> ) strategy.merge(LocatorUtils.property(leftLocator, "surface", lhsSurface), LocatorUtils.property(rightLocator, "surface", rhsSurface), lhsSurface, rhsSurface)));
            }
            {
                String lhsRemoteSchema;

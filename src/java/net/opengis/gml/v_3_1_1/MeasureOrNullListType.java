 ...
 * 
 * <p>Java-Klasse für MeasureOrNullListType complex type.
 * 
...
public class MeasureOrNullListType implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof MeasureOrNullListType) {
            final MeasureOrNullListType target = this;
            final MeasureOrNullListType leftObject = ((MeasureOrNullListType) left);
            final MeasureOrNullListType rightObject = ((MeasureOrNullListType) right);
            {
                List<String> lhsValue;

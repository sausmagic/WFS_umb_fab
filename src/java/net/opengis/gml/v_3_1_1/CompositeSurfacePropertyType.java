...
/**
 * <p>Java-Klasse für CompositeSurfacePropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CompositeSurfacePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CompositeSurfacePropertyType that = ((CompositeSurfacePropertyType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CompositeSurfacePropertyType) {
            final CompositeSurfacePropertyType copy = ((CompositeSurfacePropertyType) draftCopy);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof CompositeSurfacePropertyType) {
            final CompositeSurfacePropertyType target = this;
            final CompositeSurfacePropertyType leftObject = ((CompositeSurfacePropertyType) left);
            final CompositeSurfacePropertyType rightObject = ((CompositeSurfacePropertyType) right);
            {
                CompositeSurfaceType lhsCompositeSurface;

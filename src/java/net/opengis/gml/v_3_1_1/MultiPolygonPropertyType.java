 ...
 * 
 * <p>Java-Klasse für MultiPolygonPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der multiPolygon-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der multiPolygon-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link MultiPolygonType }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            strategy.appendField(locator, this, "multiPolygon", buffer, theMultiPolygon);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MultiPolygonPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final MultiPolygonPropertyType that = ((MultiPolygonPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "multiPolygon", lhsMultiPolygon), LocatorUtils.property(thatLocator, "multiPolygon", rhsMultiPolygon), lhsMultiPolygon, rhsMultiPolygon)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            MultiPolygonType theMultiPolygon;
            theMultiPolygon = this.getMultiPolygon();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "multiPolygon", theMultiPolygon), currentHashCode, theMultiPolygon);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof MultiPolygonPropertyType) {
            final MultiPolygonPropertyType copy = ((MultiPolygonPropertyType) draftCopy);
            if (this.isSetMultiPolygon()) {
                MultiPolygonType sourceMultiPolygon;
                sourceMultiPolygon = this.getMultiPolygon();
                MultiPolygonType copyMultiPolygon = ((MultiPolygonType) strategy.copy(LocatorUtils.property(locator, "multiPolygon", sourceMultiPolygon), sourceMultiPolygon));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof MultiPolygonPropertyType) {
            final MultiPolygonPropertyType target = this;
            final MultiPolygonPropertyType leftObject = ((MultiPolygonPropertyType) left);
            final MultiPolygonPropertyType rightObject = ((MultiPolygonPropertyType) right);
            {
                MultiPolygonType lhsMultiPolygon;
                lhsMultiPolygon = leftObject.getMultiPolygon();
                MultiPolygonType rhsMultiPolygon;
                rhsMultiPolygon = rightObject.getMultiPolygon();
                target.setMultiPolygon(((MultiPolygonType) strategy.merge(LocatorUtils.property(leftLocator, "multiPolygon", lhsMultiPolygon), LocatorUtils.property(rightLocator, "multiPolygon", rhsMultiPolygon), lhsMultiPolygon, rhsMultiPolygon)));
            }
            {
                String lhsRemoteSchema;

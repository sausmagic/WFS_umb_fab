    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        ...
        if (right instanceof SolidType) {
            ...
            final SolidType rightObject = ((SolidType) right);
            {
                ...
                target.setExterior(((SurfacePropertyType) strategy.merge(LocatorUtils.property(leftLocator, "exterior", lhsExterior), LocatorUtils.property(rightLocator, "exterior", rhsExterior), lhsExterior, rhsExterior)));
            }
            {
                List<SurfacePropertyType> lhsInterior;
                ...
                List<SurfacePropertyType> uniqueInteriorl = target.getInterior();
                uniqueInteriorl.addAll(((List<SurfacePropertyType> ) strategy.merge(LocatorUtils.property(leftLocator, "interior", lhsInterior), LocatorUtils.property(rightLocator, "interior", rhsInterior), lhsInterior, rhsInterior)));
            }
        }
    }

    public void setInterior(List<SurfacePropertyType> value) {
        List<SurfacePropertyType> draftl = this.getInterior();
        draftl.addAll(value);
    }

 ...
 * 
 * <p>Java-Klasse für PolarCSRefType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof PolarCSRefType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final PolarCSRefType that = ((PolarCSRefType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof PolarCSRefType) {
            final PolarCSRefType copy = ((PolarCSRefType) draftCopy);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof PolarCSRefType) {
            final PolarCSRefType target = this;
            final PolarCSRefType leftObject = ((PolarCSRefType) left);
            final PolarCSRefType rightObject = ((PolarCSRefType) right);
            {
                PolarCSType lhsPolarCS;

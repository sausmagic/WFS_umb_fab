...
/**
 * <p>Java-Klasse für IsolatedPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof IsolatedPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final IsolatedPropertyType that = ((IsolatedPropertyType) object);
        {
            NodeType lhsNode;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof IsolatedPropertyType) {
            final IsolatedPropertyType copy = ((IsolatedPropertyType) draftCopy);
            if (this.isSetNode()) {
                NodeType sourceNode;
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof IsolatedPropertyType) {
            final IsolatedPropertyType target = this;
            final IsolatedPropertyType leftObject = ((IsolatedPropertyType) left);
            final IsolatedPropertyType rightObject = ((IsolatedPropertyType) right);
            {
                NodeType lhsNode;

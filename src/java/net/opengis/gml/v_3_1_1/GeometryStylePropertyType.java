...
/**
 * <p>Java-Klasse für GeometryStylePropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            GeometryStyleType theGeometryStyle;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GeometryStylePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GeometryStylePropertyType that = ((GeometryStylePropertyType) object);
        {
            GeometryStyleType lhsGeometryStyle;
            lhsGeometryStyle = this.getGeometryStyle();
            GeometryStyleType rhsGeometryStyle;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof GeometryStylePropertyType) {
            final GeometryStylePropertyType copy = ((GeometryStylePropertyType) draftCopy);
            if (this.isSetGeometryStyle()) {
                GeometryStyleType sourceGeometryStyle;
                sourceGeometryStyle = this.getGeometryStyle();
                GeometryStyleType copyGeometryStyle = ((GeometryStyleType) strategy.copy(LocatorUtils.property(locator, "geometryStyle", sourceGeometryStyle), sourceGeometryStyle));
                copy.setGeometryStyle(copyGeometryStyle);
            } else {
                copy.geometryStyle = null;
            }
            if (this.isSetAbout()) {
                String sourceAbout;
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof GeometryStylePropertyType) {
            final GeometryStylePropertyType target = this;
            final GeometryStylePropertyType leftObject = ((GeometryStylePropertyType) left);
            final GeometryStylePropertyType rightObject = ((GeometryStylePropertyType) right);
            {
                GeometryStyleType lhsGeometryStyle;
                lhsGeometryStyle = leftObject.getGeometryStyle();
                GeometryStyleType rhsGeometryStyle;
                rhsGeometryStyle = rightObject.getGeometryStyle();
                target.setGeometryStyle(((GeometryStyleType) strategy.merge(LocatorUtils.property(leftLocator, "geometryStyle", lhsGeometryStyle), LocatorUtils.property(rightLocator, "geometryStyle", rhsGeometryStyle), lhsGeometryStyle, rhsGeometryStyle)));
            }
            {
                String lhsAbout;

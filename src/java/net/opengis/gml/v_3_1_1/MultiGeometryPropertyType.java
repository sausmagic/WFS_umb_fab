    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der geometricAggregate-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der geometricAggregate-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link MultiCurveType }{@code >}
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractGeometricAggregateType> theGeometricAggregate;
            theGeometricAggregate = this.getGeometricAggregate();
            strategy.appendField(locator, this, "geometricAggregate", buffer, theGeometricAggregate);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            JAXBElement<? extends AbstractGeometricAggregateType> lhsGeometricAggregate;
            lhsGeometricAggregate = this.getGeometricAggregate();
            JAXBElement<? extends AbstractGeometricAggregateType> rhsGeometricAggregate;
            rhsGeometricAggregate = that.getGeometricAggregate();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "geometricAggregate", lhsGeometricAggregate), LocatorUtils.property(thatLocator, "geometricAggregate", rhsGeometricAggregate), lhsGeometricAggregate, rhsGeometricAggregate)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractGeometricAggregateType> theGeometricAggregate;
            theGeometricAggregate = this.getGeometricAggregate();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "geometricAggregate", theGeometricAggregate), currentHashCode, theGeometricAggregate);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof MultiGeometryPropertyType) {
            ...
            if (this.isSetGeometricAggregate()) {
                JAXBElement<? extends AbstractGeometricAggregateType> sourceGeometricAggregate;
                sourceGeometricAggregate = this.getGeometricAggregate();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractGeometricAggregateType> copyGeometricAggregate = ((JAXBElement<? extends AbstractGeometricAggregateType> ) strategy.copy(LocatorUtils.property(locator, "geometricAggregate", sourceGeometricAggregate), sourceGeometricAggregate));
                copy.setGeometricAggregate(copyGeometricAggregate);
            } else {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof MultiGeometryPropertyType) {
            ...
            {
                JAXBElement<? extends AbstractGeometricAggregateType> lhsGeometricAggregate;
                lhsGeometricAggregate = leftObject.getGeometricAggregate();
                JAXBElement<? extends AbstractGeometricAggregateType> rhsGeometricAggregate;
                rhsGeometricAggregate = rightObject.getGeometricAggregate();
                target.setGeometricAggregate(((JAXBElement<? extends AbstractGeometricAggregateType> ) strategy.merge(LocatorUtils.property(leftLocator, "geometricAggregate", lhsGeometricAggregate), LocatorUtils.property(rightLocator, "geometricAggregate", rhsGeometricAggregate), lhsGeometricAggregate, rhsGeometricAggregate)));
            }
            {
                String lhsRemoteSchema;

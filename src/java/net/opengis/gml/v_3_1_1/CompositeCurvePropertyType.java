...
/**
 * <p>Java-Klasse für CompositeCurvePropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CompositeCurvePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CompositeCurvePropertyType that = ((CompositeCurvePropertyType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CompositeCurvePropertyType) {
            final CompositeCurvePropertyType copy = ((CompositeCurvePropertyType) draftCopy);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof CompositeCurvePropertyType) {
            final CompositeCurvePropertyType target = this;
            final CompositeCurvePropertyType leftObject = ((CompositeCurvePropertyType) left);
            final CompositeCurvePropertyType rightObject = ((CompositeCurvePropertyType) right);
            {
                CompositeCurveType lhsCompositeCurve;

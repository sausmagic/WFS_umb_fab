 ...
 * 
 * <p>Java-Klasse für SphericalCSRefType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SphericalCSRefType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final SphericalCSRefType that = ((SphericalCSRefType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof SphericalCSRefType) {
            final SphericalCSRefType copy = ((SphericalCSRefType) draftCopy);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof SphericalCSRefType) {
            final SphericalCSRefType target = this;
            final SphericalCSRefType leftObject = ((SphericalCSRefType) left);
            final SphericalCSRefType rightObject = ((SphericalCSRefType) right);
            {
                SphericalCSType lhsSphericalCS;

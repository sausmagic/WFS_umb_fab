 ...
 * 
 * <p>Java-Klasse für LineStringPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof LineStringPropertyType) {
            final LineStringPropertyType copy = ((LineStringPropertyType) draftCopy);
            if (this.isSetLineString()) {
                LineStringType sourceLineString;
                sourceLineString = this.getLineString();
                LineStringType copyLineString = ((LineStringType) strategy.copy(LocatorUtils.property(locator, "lineString", sourceLineString), sourceLineString));
                copy.setLineString(copyLineString);
            } else {
                copy.lineString = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof LineStringPropertyType) {
            final LineStringPropertyType target = this;
            final LineStringPropertyType leftObject = ((LineStringPropertyType) left);
            final LineStringPropertyType rightObject = ((LineStringPropertyType) right);
            {
                LineStringType lhsLineString;
                lhsLineString = leftObject.getLineString();
                LineStringType rhsLineString;
                rhsLineString = rightObject.getLineString();
                target.setLineString(((LineStringType) strategy.merge(LocatorUtils.property(leftLocator, "lineString", lhsLineString), LocatorUtils.property(rightLocator, "lineString", rhsLineString), lhsLineString, rhsLineString)));
            }
            {
                String lhsRemoteSchema;

    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        ...
        if (right instanceof TimeCalendarEraType) {
            ...
            }
            {
                ...
                target.setReferenceDate(((XMLGregorianCalendar) strategy.merge(LocatorUtils.property(leftLocator, "referenceDate", lhsReferenceDate), LocatorUtils.property(rightLocator, "referenceDate", rhsReferenceDate), lhsReferenceDate, rhsReferenceDate)));
            }
            {
                BigDecimal lhsJulianReference;

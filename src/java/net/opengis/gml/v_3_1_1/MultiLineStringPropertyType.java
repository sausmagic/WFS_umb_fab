 ...
 * 
 * <p>Java-Klasse für MultiLineStringPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der multiLineString-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der multiLineString-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link MultiLineStringType }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MultiLineStringType theMultiLineString;
            theMultiLineString = this.getMultiLineString();
            strategy.appendField(locator, this, "multiLineString", buffer, theMultiLineString);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            MultiLineStringType lhsMultiLineString;
            lhsMultiLineString = this.getMultiLineString();
            MultiLineStringType rhsMultiLineString;
            rhsMultiLineString = that.getMultiLineString();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "multiLineString", lhsMultiLineString), LocatorUtils.property(thatLocator, "multiLineString", rhsMultiLineString), lhsMultiLineString, rhsMultiLineString)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            MultiLineStringType theMultiLineString;
            theMultiLineString = this.getMultiLineString();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "multiLineString", theMultiLineString), currentHashCode, theMultiLineString);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof MultiLineStringPropertyType) {
            final MultiLineStringPropertyType copy = ((MultiLineStringPropertyType) draftCopy);
            if (this.isSetMultiLineString()) {
                MultiLineStringType sourceMultiLineString;
                sourceMultiLineString = this.getMultiLineString();
                MultiLineStringType copyMultiLineString = ((MultiLineStringType) strategy.copy(LocatorUtils.property(locator, "multiLineString", sourceMultiLineString), sourceMultiLineString));
                copy.setMultiLineString(copyMultiLineString);
            } else {
                copy.multiLineString = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof MultiLineStringPropertyType) {
            final MultiLineStringPropertyType target = this;
            final MultiLineStringPropertyType leftObject = ((MultiLineStringPropertyType) left);
            final MultiLineStringPropertyType rightObject = ((MultiLineStringPropertyType) right);
            {
                MultiLineStringType lhsMultiLineString;
                lhsMultiLineString = leftObject.getMultiLineString();
                MultiLineStringType rhsMultiLineString;
                rhsMultiLineString = rightObject.getMultiLineString();
                target.setMultiLineString(((MultiLineStringType) strategy.merge(LocatorUtils.property(leftLocator, "multiLineString", lhsMultiLineString), LocatorUtils.property(rightLocator, "multiLineString", rhsMultiLineString), lhsMultiLineString, rhsMultiLineString)));
            }
            {
                String lhsRemoteSchema;

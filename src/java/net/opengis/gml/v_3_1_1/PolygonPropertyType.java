 ...
 * 
 * <p>Java-Klasse für PolygonPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof PolygonPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final PolygonPropertyType that = ((PolygonPropertyType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof PolygonPropertyType) {
            final PolygonPropertyType copy = ((PolygonPropertyType) draftCopy);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof PolygonPropertyType) {
            final PolygonPropertyType target = this;
            final PolygonPropertyType leftObject = ((PolygonPropertyType) left);
            final PolygonPropertyType rightObject = ((PolygonPropertyType) right);
            {
                PolygonType lhsPolygon;
                lhsPolygon = leftObject.getPolygon();
                PolygonType rhsPolygon;
                rhsPolygon = rightObject.getPolygon();
                target.setPolygon(((PolygonType) strategy.merge(LocatorUtils.property(leftLocator, "polygon", lhsPolygon), LocatorUtils.property(rightLocator, "polygon", rhsPolygon), lhsPolygon, rhsPolygon)));
            }
            {
                String lhsRemoteSchema;

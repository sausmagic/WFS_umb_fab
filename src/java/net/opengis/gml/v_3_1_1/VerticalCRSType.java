    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        ...
        if (right instanceof VerticalCRSType) {
            ...
            final VerticalCRSType rightObject = ((VerticalCRSType) right);
            {
                ...
                target.setUsesVerticalCS(((VerticalCSRefType) strategy.merge(LocatorUtils.property(leftLocator, "usesVerticalCS", lhsUsesVerticalCS), LocatorUtils.property(rightLocator, "usesVerticalCS", rhsUsesVerticalCS), lhsUsesVerticalCS, rhsUsesVerticalCS)));
            }
            {
                VerticalDatumRefType lhsUsesVerticalDatum;
                ...
                target.setUsesVerticalDatum(((VerticalDatumRefType) strategy.merge(LocatorUtils.property(leftLocator, "usesVerticalDatum", lhsUsesVerticalDatum), LocatorUtils.property(rightLocator, "usesVerticalDatum", rhsUsesVerticalDatum), lhsUsesVerticalDatum, rhsUsesVerticalDatum)));
            }
        }
    }

 ...
 * 
 * <p>Java-Klasse für OperationRefType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractCoordinateOperationType> theOperation;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof OperationRefType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final OperationRefType that = ((OperationRefType) object);
        {
            JAXBElement<? extends AbstractCoordinateOperationType> lhsOperation;
            lhsOperation = this.getOperation();
            JAXBElement<? extends AbstractCoordinateOperationType> rhsOperation;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof OperationRefType) {
            final OperationRefType copy = ((OperationRefType) draftCopy);
            if (this.isSetOperation()) {
                JAXBElement<? extends AbstractCoordinateOperationType> sourceOperation;
                sourceOperation = this.getOperation();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractCoordinateOperationType> copyOperation = ((JAXBElement<? extends AbstractCoordinateOperationType> ) strategy.copy(LocatorUtils.property(locator, "operation", sourceOperation), sourceOperation));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof OperationRefType) {
            final OperationRefType target = this;
            final OperationRefType leftObject = ((OperationRefType) left);
            final OperationRefType rightObject = ((OperationRefType) right);
            {
                JAXBElement<? extends AbstractCoordinateOperationType> lhsOperation;
                lhsOperation = leftObject.getOperation();
                JAXBElement<? extends AbstractCoordinateOperationType> rhsOperation;
                rhsOperation = rightObject.getOperation();
                target.setOperation(((JAXBElement<? extends AbstractCoordinateOperationType> ) strategy.merge(LocatorUtils.property(leftLocator, "operation", lhsOperation), LocatorUtils.property(rightLocator, "operation", rhsOperation), lhsOperation, rhsOperation)));
            }
            {
                String lhsRemoteSchema;

    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof AbstractRingPropertyType) {
            ...
            final AbstractRingPropertyType rightObject = ((AbstractRingPropertyType) right);
            {
                ...
                target.setRing(((JAXBElement<? extends AbstractRingType> ) strategy.merge(LocatorUtils.property(leftLocator, "ring", lhsRing), LocatorUtils.property(rightLocator, "ring", rhsRing), lhsRing, rhsRing)));
            }
        }
    }

 ...
 * 
 * <p>Java-Klasse für DerivedCRSRefType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DerivedCRSRefType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DerivedCRSRefType that = ((DerivedCRSRefType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof DerivedCRSRefType) {
            final DerivedCRSRefType copy = ((DerivedCRSRefType) draftCopy);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof DerivedCRSRefType) {
            final DerivedCRSRefType target = this;
            final DerivedCRSRefType leftObject = ((DerivedCRSRefType) left);
            final DerivedCRSRefType rightObject = ((DerivedCRSRefType) right);
            {
                DerivedCRSType lhsDerivedCRS;

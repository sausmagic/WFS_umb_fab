 ...
 * 
 * <p>Java-Klasse für CylindricalCSRefType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CylindricalCSRefType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CylindricalCSRefType that = ((CylindricalCSRefType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CylindricalCSRefType) {
            final CylindricalCSRefType copy = ((CylindricalCSRefType) draftCopy);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof CylindricalCSRefType) {
            final CylindricalCSRefType target = this;
            final CylindricalCSRefType leftObject = ((CylindricalCSRefType) left);
            final CylindricalCSRefType rightObject = ((CylindricalCSRefType) right);
            {
                CylindricalCSType lhsCylindricalCS;

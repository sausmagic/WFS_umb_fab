    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractCoordinateSystemType> theCoordinateSystem;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            JAXBElement<? extends AbstractCoordinateSystemType> lhsCoordinateSystem;
            lhsCoordinateSystem = this.getCoordinateSystem();
            JAXBElement<? extends AbstractCoordinateSystemType> rhsCoordinateSystem;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CoordinateSystemRefType) {
            final CoordinateSystemRefType copy = ((CoordinateSystemRefType) draftCopy);
            if (this.isSetCoordinateSystem()) {
                JAXBElement<? extends AbstractCoordinateSystemType> sourceCoordinateSystem;
                sourceCoordinateSystem = this.getCoordinateSystem();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractCoordinateSystemType> copyCoordinateSystem = ((JAXBElement<? extends AbstractCoordinateSystemType> ) strategy.copy(LocatorUtils.property(locator, "coordinateSystem", sourceCoordinateSystem), sourceCoordinateSystem));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof CoordinateSystemRefType) {
            final CoordinateSystemRefType target = this;
            final CoordinateSystemRefType leftObject = ((CoordinateSystemRefType) left);
            final CoordinateSystemRefType rightObject = ((CoordinateSystemRefType) right);
            {
                JAXBElement<? extends AbstractCoordinateSystemType> lhsCoordinateSystem;
                lhsCoordinateSystem = leftObject.getCoordinateSystem();
                JAXBElement<? extends AbstractCoordinateSystemType> rhsCoordinateSystem;
                rhsCoordinateSystem = rightObject.getCoordinateSystem();
                target.setCoordinateSystem(((JAXBElement<? extends AbstractCoordinateSystemType> ) strategy.merge(LocatorUtils.property(leftLocator, "coordinateSystem", lhsCoordinateSystem), LocatorUtils.property(rightLocator, "coordinateSystem", rhsCoordinateSystem), lhsCoordinateSystem, rhsCoordinateSystem)));
            }
            {
                String lhsRemoteSchema;

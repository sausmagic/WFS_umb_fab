 ...
 * 
 * <p>Java-Klasse für LinearCSRefType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof LinearCSRefType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final LinearCSRefType that = ((LinearCSRefType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof LinearCSRefType) {
            final LinearCSRefType copy = ((LinearCSRefType) draftCopy);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof LinearCSRefType) {
            final LinearCSRefType target = this;
            final LinearCSRefType leftObject = ((LinearCSRefType) left);
            final LinearCSRefType rightObject = ((LinearCSRefType) right);
            {
                LinearCSType lhsLinearCS;

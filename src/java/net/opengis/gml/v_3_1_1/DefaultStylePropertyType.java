 ...
 * 
 * <p>Java-Klasse für DefaultStylePropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractStyleType> theStyle;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DefaultStylePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DefaultStylePropertyType that = ((DefaultStylePropertyType) object);
        {
            JAXBElement<? extends AbstractStyleType> lhsStyle;
            lhsStyle = this.getStyle();
            JAXBElement<? extends AbstractStyleType> rhsStyle;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof DefaultStylePropertyType) {
            final DefaultStylePropertyType copy = ((DefaultStylePropertyType) draftCopy);
            if (this.isSetStyle()) {
                JAXBElement<? extends AbstractStyleType> sourceStyle;
                sourceStyle = this.getStyle();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractStyleType> copyStyle = ((JAXBElement<? extends AbstractStyleType> ) strategy.copy(LocatorUtils.property(locator, "style", sourceStyle), sourceStyle));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof DefaultStylePropertyType) {
            final DefaultStylePropertyType target = this;
            final DefaultStylePropertyType leftObject = ((DefaultStylePropertyType) left);
            final DefaultStylePropertyType rightObject = ((DefaultStylePropertyType) right);
            {
                JAXBElement<? extends AbstractStyleType> lhsStyle;
                lhsStyle = leftObject.getStyle();
                JAXBElement<? extends AbstractStyleType> rhsStyle;
                rhsStyle = rightObject.getStyle();
                target.setStyle(((JAXBElement<? extends AbstractStyleType> ) strategy.merge(LocatorUtils.property(leftLocator, "style", lhsStyle), LocatorUtils.property(rightLocator, "style", rhsStyle), lhsStyle, rhsStyle)));
            }
            {
                String lhsAbout;

    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        ...
        if (right instanceof EnvelopeWithTimePeriodType) {
            ...
            final EnvelopeWithTimePeriodType rightObject = ((EnvelopeWithTimePeriodType) right);
            {
                ...
                uniqueTimePositionl.addAll(((List<TimePositionType> ) strategy.merge(LocatorUtils.property(leftLocator, "timePosition", lhsTimePosition), LocatorUtils.property(rightLocator, "timePosition", rhsTimePosition), lhsTimePosition, rhsTimePosition)));
            }
            {
                String lhsFrame;

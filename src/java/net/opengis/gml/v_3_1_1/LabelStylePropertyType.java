...
/**
 * <p>Java-Klasse für LabelStylePropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof LabelStylePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final LabelStylePropertyType that = ((LabelStylePropertyType) object);
        {
            LabelStyleType lhsLabelStyle;
            lhsLabelStyle = this.getLabelStyle();
            LabelStyleType rhsLabelStyle;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof LabelStylePropertyType) {
            final LabelStylePropertyType copy = ((LabelStylePropertyType) draftCopy);
            if (this.isSetLabelStyle()) {
                LabelStyleType sourceLabelStyle;
                sourceLabelStyle = this.getLabelStyle();
                LabelStyleType copyLabelStyle = ((LabelStyleType) strategy.copy(LocatorUtils.property(locator, "labelStyle", sourceLabelStyle), sourceLabelStyle));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof LabelStylePropertyType) {
            final LabelStylePropertyType target = this;
            final LabelStylePropertyType leftObject = ((LabelStylePropertyType) left);
            final LabelStylePropertyType rightObject = ((LabelStylePropertyType) right);
            {
                LabelStyleType lhsLabelStyle;
                lhsLabelStyle = leftObject.getLabelStyle();
                LabelStyleType rhsLabelStyle;
                rhsLabelStyle = rightObject.getLabelStyle();
                target.setLabelStyle(((LabelStyleType) strategy.merge(LocatorUtils.property(leftLocator, "labelStyle", lhsLabelStyle), LocatorUtils.property(rightLocator, "labelStyle", rhsLabelStyle), lhsLabelStyle, rhsLabelStyle)));
            }
            {
                String lhsAbout;

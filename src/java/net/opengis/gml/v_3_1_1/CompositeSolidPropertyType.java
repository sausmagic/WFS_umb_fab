...
/**
 * <p>Java-Klasse für CompositeSolidPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CompositeSolidPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CompositeSolidPropertyType that = ((CompositeSolidPropertyType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CompositeSolidPropertyType) {
            final CompositeSolidPropertyType copy = ((CompositeSolidPropertyType) draftCopy);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof CompositeSolidPropertyType) {
            final CompositeSolidPropertyType target = this;
            final CompositeSolidPropertyType leftObject = ((CompositeSolidPropertyType) left);
            final CompositeSolidPropertyType rightObject = ((CompositeSolidPropertyType) right);
            {
                CompositeSolidType lhsCompositeSolid;

 ...
 * 
 * <p>Java-Klasse für EngineeringCRSRefType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof EngineeringCRSRefType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final EngineeringCRSRefType that = ((EngineeringCRSRefType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof EngineeringCRSRefType) {
            final EngineeringCRSRefType copy = ((EngineeringCRSRefType) draftCopy);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof EngineeringCRSRefType) {
            final EngineeringCRSRefType target = this;
            final EngineeringCRSRefType leftObject = ((EngineeringCRSRefType) left);
            final EngineeringCRSRefType rightObject = ((EngineeringCRSRefType) right);
            {
                EngineeringCRSType lhsEngineeringCRS;

    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof AngleChoiceType) {
            ...
            final AngleChoiceType rightObject = ((AngleChoiceType) right);
            {
                ...
                target.setAngle(((MeasureType) strategy.merge(LocatorUtils.property(leftLocator, "angle", lhsAngle), LocatorUtils.property(rightLocator, "angle", rhsAngle), lhsAngle, rhsAngle)));
            }
            {
                DMSAngleType lhsDmsAngle;

 ...
 * 
 * <p>Java-Klasse für ConcatenatedOperationRefType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ConcatenatedOperationRefType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ConcatenatedOperationRefType that = ((ConcatenatedOperationRefType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof ConcatenatedOperationRefType) {
            final ConcatenatedOperationRefType copy = ((ConcatenatedOperationRefType) draftCopy);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof ConcatenatedOperationRefType) {
            final ConcatenatedOperationRefType target = this;
            final ConcatenatedOperationRefType leftObject = ((ConcatenatedOperationRefType) left);
            final ConcatenatedOperationRefType rightObject = ((ConcatenatedOperationRefType) right);
            {
                ConcatenatedOperationType lhsConcatenatedOperation;

    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der timeTopologyPrimitive-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der timeTopologyPrimitive-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link TimeEdgeType }{@code >}
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractTimeTopologyPrimitiveType> theTimeTopologyPrimitive;
            theTimeTopologyPrimitive = this.getTimeTopologyPrimitive();
            strategy.appendField(locator, this, "timeTopologyPrimitive", buffer, theTimeTopologyPrimitive);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            JAXBElement<? extends AbstractTimeTopologyPrimitiveType> lhsTimeTopologyPrimitive;
            lhsTimeTopologyPrimitive = this.getTimeTopologyPrimitive();
            JAXBElement<? extends AbstractTimeTopologyPrimitiveType> rhsTimeTopologyPrimitive;
            rhsTimeTopologyPrimitive = that.getTimeTopologyPrimitive();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "timeTopologyPrimitive", lhsTimeTopologyPrimitive), LocatorUtils.property(thatLocator, "timeTopologyPrimitive", rhsTimeTopologyPrimitive), lhsTimeTopologyPrimitive, rhsTimeTopologyPrimitive)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractTimeTopologyPrimitiveType> theTimeTopologyPrimitive;
            theTimeTopologyPrimitive = this.getTimeTopologyPrimitive();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "timeTopologyPrimitive", theTimeTopologyPrimitive), currentHashCode, theTimeTopologyPrimitive);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TimeTopologyPrimitivePropertyType) {
            ...
            if (this.isSetTimeTopologyPrimitive()) {
                JAXBElement<? extends AbstractTimeTopologyPrimitiveType> sourceTimeTopologyPrimitive;
                sourceTimeTopologyPrimitive = this.getTimeTopologyPrimitive();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractTimeTopologyPrimitiveType> copyTimeTopologyPrimitive = ((JAXBElement<? extends AbstractTimeTopologyPrimitiveType> ) strategy.copy(LocatorUtils.property(locator, "timeTopologyPrimitive", sourceTimeTopologyPrimitive), sourceTimeTopologyPrimitive));
                copy.setTimeTopologyPrimitive(copyTimeTopologyPrimitive);
            } else {
                copy.timeTopologyPrimitive = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof TimeTopologyPrimitivePropertyType) {
            ...
            {
                JAXBElement<? extends AbstractTimeTopologyPrimitiveType> lhsTimeTopologyPrimitive;
                lhsTimeTopologyPrimitive = leftObject.getTimeTopologyPrimitive();
                JAXBElement<? extends AbstractTimeTopologyPrimitiveType> rhsTimeTopologyPrimitive;
                rhsTimeTopologyPrimitive = rightObject.getTimeTopologyPrimitive();
                target.setTimeTopologyPrimitive(((JAXBElement<? extends AbstractTimeTopologyPrimitiveType> ) strategy.merge(LocatorUtils.property(leftLocator, "timeTopologyPrimitive", lhsTimeTopologyPrimitive), LocatorUtils.property(rightLocator, "timeTopologyPrimitive", rhsTimeTopologyPrimitive), lhsTimeTopologyPrimitive, rhsTimeTopologyPrimitive)));
            }
            {
                String lhsRemoteSchema;

    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        ...
        if (right instanceof ImageDatumType) {
            ...
            final ImageDatumType rightObject = ((ImageDatumType) right);
            {
                ...
                target.setPixelInCell(((PixelInCellType) strategy.merge(LocatorUtils.property(leftLocator, "pixelInCell", lhsPixelInCell), LocatorUtils.property(rightLocator, "pixelInCell", rhsPixelInCell), lhsPixelInCell, rhsPixelInCell)));
            }
        }
    }

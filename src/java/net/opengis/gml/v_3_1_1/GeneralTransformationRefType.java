 ...
 * 
 * <p>Java-Klasse für GeneralTransformationRefType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der generalTransformation-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der generalTransformation-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link AbstractGeneralTransformationType }{@code >}
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractGeneralTransformationType> theGeneralTransformation;
            theGeneralTransformation = this.getGeneralTransformation();
            strategy.appendField(locator, this, "generalTransformation", buffer, theGeneralTransformation);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GeneralTransformationRefType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GeneralTransformationRefType that = ((GeneralTransformationRefType) object);
        {
            JAXBElement<? extends AbstractGeneralTransformationType> lhsGeneralTransformation;
            lhsGeneralTransformation = this.getGeneralTransformation();
            JAXBElement<? extends AbstractGeneralTransformationType> rhsGeneralTransformation;
            rhsGeneralTransformation = that.getGeneralTransformation();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "generalTransformation", lhsGeneralTransformation), LocatorUtils.property(thatLocator, "generalTransformation", rhsGeneralTransformation), lhsGeneralTransformation, rhsGeneralTransformation)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractGeneralTransformationType> theGeneralTransformation;
            theGeneralTransformation = this.getGeneralTransformation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "generalTransformation", theGeneralTransformation), currentHashCode, theGeneralTransformation);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof GeneralTransformationRefType) {
            final GeneralTransformationRefType copy = ((GeneralTransformationRefType) draftCopy);
            if (this.isSetGeneralTransformation()) {
                JAXBElement<? extends AbstractGeneralTransformationType> sourceGeneralTransformation;
                sourceGeneralTransformation = this.getGeneralTransformation();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractGeneralTransformationType> copyGeneralTransformation = ((JAXBElement<? extends AbstractGeneralTransformationType> ) strategy.copy(LocatorUtils.property(locator, "generalTransformation", sourceGeneralTransformation), sourceGeneralTransformation));
                copy.setGeneralTransformation(copyGeneralTransformation);
            } else {
                copy.generalTransformation = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof GeneralTransformationRefType) {
            final GeneralTransformationRefType target = this;
            final GeneralTransformationRefType leftObject = ((GeneralTransformationRefType) left);
            final GeneralTransformationRefType rightObject = ((GeneralTransformationRefType) right);
            {
                JAXBElement<? extends AbstractGeneralTransformationType> lhsGeneralTransformation;
                lhsGeneralTransformation = leftObject.getGeneralTransformation();
                JAXBElement<? extends AbstractGeneralTransformationType> rhsGeneralTransformation;
                rhsGeneralTransformation = rightObject.getGeneralTransformation();
                target.setGeneralTransformation(((JAXBElement<? extends AbstractGeneralTransformationType> ) strategy.merge(LocatorUtils.property(leftLocator, "generalTransformation", lhsGeneralTransformation), LocatorUtils.property(rightLocator, "generalTransformation", rhsGeneralTransformation), lhsGeneralTransformation, rhsGeneralTransformation)));
            }
            {
                String lhsRemoteSchema;

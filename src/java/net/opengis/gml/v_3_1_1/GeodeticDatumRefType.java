 ...
 * 
 * <p>Java-Klasse für GeodeticDatumRefType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GeodeticDatumRefType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GeodeticDatumRefType that = ((GeodeticDatumRefType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof GeodeticDatumRefType) {
            final GeodeticDatumRefType copy = ((GeodeticDatumRefType) draftCopy);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof GeodeticDatumRefType) {
            final GeodeticDatumRefType target = this;
            final GeodeticDatumRefType leftObject = ((GeodeticDatumRefType) left);
            final GeodeticDatumRefType rightObject = ((GeodeticDatumRefType) right);
            {
                GeodeticDatumType lhsGeodeticDatum;

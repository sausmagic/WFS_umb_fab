...
/**
 * <p>Java-Klasse für FeatureStylePropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der featureStyle-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der featureStyle-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link FeatureStyleType }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            FeatureStyleType theFeatureStyle;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof FeatureStylePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final FeatureStylePropertyType that = ((FeatureStylePropertyType) object);
        {
            FeatureStyleType lhsFeatureStyle;
            lhsFeatureStyle = this.getFeatureStyle();
            FeatureStyleType rhsFeatureStyle;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof FeatureStylePropertyType) {
            final FeatureStylePropertyType copy = ((FeatureStylePropertyType) draftCopy);
            if (this.isSetFeatureStyle()) {
                FeatureStyleType sourceFeatureStyle;
                sourceFeatureStyle = this.getFeatureStyle();
                FeatureStyleType copyFeatureStyle = ((FeatureStyleType) strategy.copy(LocatorUtils.property(locator, "featureStyle", sourceFeatureStyle), sourceFeatureStyle));
                copy.setFeatureStyle(copyFeatureStyle);
            } else {
                copy.featureStyle = null;
            }
            if (this.isSetAbout()) {
                String sourceAbout;
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof FeatureStylePropertyType) {
            final FeatureStylePropertyType target = this;
            final FeatureStylePropertyType leftObject = ((FeatureStylePropertyType) left);
            final FeatureStylePropertyType rightObject = ((FeatureStylePropertyType) right);
            {
                FeatureStyleType lhsFeatureStyle;
                lhsFeatureStyle = leftObject.getFeatureStyle();
                FeatureStyleType rhsFeatureStyle;
                rhsFeatureStyle = rightObject.getFeatureStyle();
                target.setFeatureStyle(((FeatureStyleType) strategy.merge(LocatorUtils.property(leftLocator, "featureStyle", lhsFeatureStyle), LocatorUtils.property(rightLocator, "featureStyle", rhsFeatureStyle), lhsFeatureStyle, rhsFeatureStyle)));
            }
            {
                String lhsAbout;

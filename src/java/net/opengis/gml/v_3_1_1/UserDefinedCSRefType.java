 ...
 * 
 * <p>Java-Klasse für UserDefinedCSRefType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof UserDefinedCSRefType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final UserDefinedCSRefType that = ((UserDefinedCSRefType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof UserDefinedCSRefType) {
            final UserDefinedCSRefType copy = ((UserDefinedCSRefType) draftCopy);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof UserDefinedCSRefType) {
            final UserDefinedCSRefType target = this;
            final UserDefinedCSRefType leftObject = ((UserDefinedCSRefType) left);
            final UserDefinedCSRefType rightObject = ((UserDefinedCSRefType) right);
            {
                UserDefinedCSType lhsUserDefinedCS;

    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof VerticalCSRefType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final VerticalCSRefType that = ((VerticalCSRefType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof VerticalCSRefType) {
            final VerticalCSRefType copy = ((VerticalCSRefType) draftCopy);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof VerticalCSRefType) {
            final VerticalCSRefType target = this;
            final VerticalCSRefType leftObject = ((VerticalCSRefType) left);
            final VerticalCSRefType rightObject = ((VerticalCSRefType) right);
            {
                VerticalCSType lhsVerticalCS;

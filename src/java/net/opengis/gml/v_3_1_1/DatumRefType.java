 ...
 * 
 * <p>Java-Klasse für DatumRefType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractDatumType> theDatum;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DatumRefType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DatumRefType that = ((DatumRefType) object);
        {
            JAXBElement<? extends AbstractDatumType> lhsDatum;
            lhsDatum = this.getDatum();
            JAXBElement<? extends AbstractDatumType> rhsDatum;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof DatumRefType) {
            final DatumRefType copy = ((DatumRefType) draftCopy);
            if (this.isSetDatum()) {
                JAXBElement<? extends AbstractDatumType> sourceDatum;
                sourceDatum = this.getDatum();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractDatumType> copyDatum = ((JAXBElement<? extends AbstractDatumType> ) strategy.copy(LocatorUtils.property(locator, "datum", sourceDatum), sourceDatum));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof DatumRefType) {
            final DatumRefType target = this;
            final DatumRefType leftObject = ((DatumRefType) left);
            final DatumRefType rightObject = ((DatumRefType) right);
            {
                JAXBElement<? extends AbstractDatumType> lhsDatum;
                lhsDatum = leftObject.getDatum();
                JAXBElement<? extends AbstractDatumType> rhsDatum;
                rhsDatum = rightObject.getDatum();
                target.setDatum(((JAXBElement<? extends AbstractDatumType> ) strategy.merge(LocatorUtils.property(leftLocator, "datum", lhsDatum), LocatorUtils.property(rightLocator, "datum", rhsDatum), lhsDatum, rhsDatum)));
            }
            {
                String lhsRemoteSchema;

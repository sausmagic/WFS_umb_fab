 ...
 * 
 * <p>Java-Klasse für CoordinateReferenceSystemRefType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der coordinateReferenceSystem-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der coordinateReferenceSystem-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ProjectedCRSType }{@code >}
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof CoordinateReferenceSystemRefType) {
            final CoordinateReferenceSystemRefType target = this;
            final CoordinateReferenceSystemRefType leftObject = ((CoordinateReferenceSystemRefType) left);
            final CoordinateReferenceSystemRefType rightObject = ((CoordinateReferenceSystemRefType) right);
            {
                JAXBElement<? extends AbstractReferenceSystemType> lhsCoordinateReferenceSystem;
                ...
                target.setCoordinateReferenceSystem(((JAXBElement<? extends AbstractReferenceSystemType> ) strategy.merge(LocatorUtils.property(leftLocator, "coordinateReferenceSystem", lhsCoordinateReferenceSystem), LocatorUtils.property(rightLocator, "coordinateReferenceSystem", rhsCoordinateReferenceSystem), lhsCoordinateReferenceSystem, rhsCoordinateReferenceSystem)));
            }
            {
                String lhsRemoteSchema;

 ...
 * 
 * <p>Java-Klasse für OperationMethodRefType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof OperationMethodRefType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final OperationMethodRefType that = ((OperationMethodRefType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof OperationMethodRefType) {
            final OperationMethodRefType copy = ((OperationMethodRefType) draftCopy);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof OperationMethodRefType) {
            final OperationMethodRefType target = this;
            final OperationMethodRefType leftObject = ((OperationMethodRefType) left);
            final OperationMethodRefType rightObject = ((OperationMethodRefType) right);
            {
                OperationMethodType lhsOperationMethod;

 ...
 * 
 * <p>Java-Klasse für SingleOperationRefType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der singleOperation-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der singleOperation-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link AbstractGeneralConversionType }{@code >}
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof SingleOperationRefType) {
            final SingleOperationRefType target = this;
            final SingleOperationRefType leftObject = ((SingleOperationRefType) left);
            final SingleOperationRefType rightObject = ((SingleOperationRefType) right);
            {
                JAXBElement<? extends AbstractCoordinateOperationType> lhsSingleOperation;
                lhsSingleOperation = leftObject.getSingleOperation();
                JAXBElement<? extends AbstractCoordinateOperationType> rhsSingleOperation;
                rhsSingleOperation = rightObject.getSingleOperation();
                target.setSingleOperation(((JAXBElement<? extends AbstractCoordinateOperationType> ) strategy.merge(LocatorUtils.property(leftLocator, "singleOperation", lhsSingleOperation), LocatorUtils.property(rightLocator, "singleOperation", rhsSingleOperation), lhsSingleOperation, rhsSingleOperation)));
            }
            {
                String lhsRemoteSchema;

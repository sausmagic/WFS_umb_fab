    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der coordinateOperation-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der coordinateOperation-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link AbstractCoordinateOperationType }{@code >}
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractCoordinateOperationType> theCoordinateOperation;
            theCoordinateOperation = this.getCoordinateOperation();
            strategy.appendField(locator, this, "coordinateOperation", buffer, theCoordinateOperation);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CoordinateOperationRefType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CoordinateOperationRefType that = ((CoordinateOperationRefType) object);
        {
            JAXBElement<? extends AbstractCoordinateOperationType> lhsCoordinateOperation;
            lhsCoordinateOperation = this.getCoordinateOperation();
            JAXBElement<? extends AbstractCoordinateOperationType> rhsCoordinateOperation;
            rhsCoordinateOperation = that.getCoordinateOperation();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "coordinateOperation", lhsCoordinateOperation), LocatorUtils.property(thatLocator, "coordinateOperation", rhsCoordinateOperation), lhsCoordinateOperation, rhsCoordinateOperation)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractCoordinateOperationType> theCoordinateOperation;
            theCoordinateOperation = this.getCoordinateOperation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "coordinateOperation", theCoordinateOperation), currentHashCode, theCoordinateOperation);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CoordinateOperationRefType) {
            final CoordinateOperationRefType copy = ((CoordinateOperationRefType) draftCopy);
            if (this.isSetCoordinateOperation()) {
                JAXBElement<? extends AbstractCoordinateOperationType> sourceCoordinateOperation;
                sourceCoordinateOperation = this.getCoordinateOperation();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractCoordinateOperationType> copyCoordinateOperation = ((JAXBElement<? extends AbstractCoordinateOperationType> ) strategy.copy(LocatorUtils.property(locator, "coordinateOperation", sourceCoordinateOperation), sourceCoordinateOperation));
                copy.setCoordinateOperation(copyCoordinateOperation);
            } else {
                copy.coordinateOperation = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof CoordinateOperationRefType) {
            final CoordinateOperationRefType target = this;
            final CoordinateOperationRefType leftObject = ((CoordinateOperationRefType) left);
            final CoordinateOperationRefType rightObject = ((CoordinateOperationRefType) right);
            {
                JAXBElement<? extends AbstractCoordinateOperationType> lhsCoordinateOperation;
                lhsCoordinateOperation = leftObject.getCoordinateOperation();
                JAXBElement<? extends AbstractCoordinateOperationType> rhsCoordinateOperation;
                rhsCoordinateOperation = rightObject.getCoordinateOperation();
                target.setCoordinateOperation(((JAXBElement<? extends AbstractCoordinateOperationType> ) strategy.merge(LocatorUtils.property(leftLocator, "coordinateOperation", lhsCoordinateOperation), LocatorUtils.property(rightLocator, "coordinateOperation", rhsCoordinateOperation), lhsCoordinateOperation, rhsCoordinateOperation)));
            }
            {
                String lhsRemoteSchema;

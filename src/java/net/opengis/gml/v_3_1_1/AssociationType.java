    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof AssociationType) {
            ...
            if (this.isSetObject()) {
                ...
                Element copyObject = ((Element) strategy.copy(LocatorUtils.property(locator, "object", sourceObject), sourceObject));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof AssociationType) {
            final AssociationType target = this;
            final AssociationType leftObject = ((AssociationType) left);
            final AssociationType rightObject = ((AssociationType) right);
            {
                Element lhsObject;
                lhsObject = leftObject.getObject();
                Element rhsObject;
                rhsObject = rightObject.getObject();
                target.setObject(((Element) strategy.merge(LocatorUtils.property(leftLocator, "object", lhsObject), LocatorUtils.property(rightLocator, "object", rhsObject), lhsObject, rhsObject)));
            }
            {
                String lhsRemoteSchema;

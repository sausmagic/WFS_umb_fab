 ...
 * 
 * <p>Java-Klasse für GeneralConversionRefType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der generalConversion-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der generalConversion-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ConversionType }{@code >}
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractGeneralConversionType> theGeneralConversion;
            theGeneralConversion = this.getGeneralConversion();
            strategy.appendField(locator, this, "generalConversion", buffer, theGeneralConversion);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GeneralConversionRefType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GeneralConversionRefType that = ((GeneralConversionRefType) object);
        {
            JAXBElement<? extends AbstractGeneralConversionType> lhsGeneralConversion;
            lhsGeneralConversion = this.getGeneralConversion();
            JAXBElement<? extends AbstractGeneralConversionType> rhsGeneralConversion;
            rhsGeneralConversion = that.getGeneralConversion();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "generalConversion", lhsGeneralConversion), LocatorUtils.property(thatLocator, "generalConversion", rhsGeneralConversion), lhsGeneralConversion, rhsGeneralConversion)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractGeneralConversionType> theGeneralConversion;
            theGeneralConversion = this.getGeneralConversion();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "generalConversion", theGeneralConversion), currentHashCode, theGeneralConversion);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof GeneralConversionRefType) {
            final GeneralConversionRefType copy = ((GeneralConversionRefType) draftCopy);
            if (this.isSetGeneralConversion()) {
                JAXBElement<? extends AbstractGeneralConversionType> sourceGeneralConversion;
                sourceGeneralConversion = this.getGeneralConversion();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractGeneralConversionType> copyGeneralConversion = ((JAXBElement<? extends AbstractGeneralConversionType> ) strategy.copy(LocatorUtils.property(locator, "generalConversion", sourceGeneralConversion), sourceGeneralConversion));
                copy.setGeneralConversion(copyGeneralConversion);
            } else {
                copy.generalConversion = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof GeneralConversionRefType) {
            final GeneralConversionRefType target = this;
            final GeneralConversionRefType leftObject = ((GeneralConversionRefType) left);
            final GeneralConversionRefType rightObject = ((GeneralConversionRefType) right);
            {
                JAXBElement<? extends AbstractGeneralConversionType> lhsGeneralConversion;
                lhsGeneralConversion = leftObject.getGeneralConversion();
                JAXBElement<? extends AbstractGeneralConversionType> rhsGeneralConversion;
                rhsGeneralConversion = rightObject.getGeneralConversion();
                target.setGeneralConversion(((JAXBElement<? extends AbstractGeneralConversionType> ) strategy.merge(LocatorUtils.property(leftLocator, "generalConversion", lhsGeneralConversion), LocatorUtils.property(rightLocator, "generalConversion", rhsGeneralConversion), lhsGeneralConversion, rhsGeneralConversion)));
            }
            {
                String lhsRemoteSchema;

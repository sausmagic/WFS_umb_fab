...
public abstract class AbstractPositionalAccuracyType implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AbstractPositionalAccuracyType)) {
            return false;
        }
        if (this == object) {
            return true;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (target instanceof AbstractPositionalAccuracyType) {
            ...
            if (this.isSetMeasureDescription()) {
                CodeType sourceMeasureDescription;
                sourceMeasureDescription = this.getMeasureDescription();
                CodeType copyMeasureDescription = ((CodeType) strategy.copy(LocatorUtils.property(locator, "measureDescription", sourceMeasureDescription), sourceMeasureDescription));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof AbstractPositionalAccuracyType) {
            ...
            final AbstractPositionalAccuracyType rightObject = ((AbstractPositionalAccuracyType) right);
            {
                ...
                target.setMeasureDescription(((CodeType) strategy.merge(LocatorUtils.property(leftLocator, "measureDescription", lhsMeasureDescription), LocatorUtils.property(rightLocator, "measureDescription", rhsMeasureDescription), lhsMeasureDescription, rhsMeasureDescription)));
            }
        }
    }

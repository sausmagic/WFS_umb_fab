 ...
 * 
 * <p>Java-Klasse für TopoComplexMemberType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TopoComplexMemberType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final TopoComplexMemberType that = ((TopoComplexMemberType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TopoComplexMemberType) {
            final TopoComplexMemberType copy = ((TopoComplexMemberType) draftCopy);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof TopoComplexMemberType) {
            final TopoComplexMemberType target = this;
            final TopoComplexMemberType leftObject = ((TopoComplexMemberType) left);
            final TopoComplexMemberType rightObject = ((TopoComplexMemberType) right);
            {
                TopoComplexType lhsTopoComplex;

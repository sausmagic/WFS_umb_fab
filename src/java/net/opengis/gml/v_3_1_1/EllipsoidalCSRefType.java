 ...
 * 
 * <p>Java-Klasse für EllipsoidalCSRefType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof EllipsoidalCSRefType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final EllipsoidalCSRefType that = ((EllipsoidalCSRefType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof EllipsoidalCSRefType) {
            final EllipsoidalCSRefType copy = ((EllipsoidalCSRefType) draftCopy);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof EllipsoidalCSRefType) {
            final EllipsoidalCSRefType target = this;
            final EllipsoidalCSRefType leftObject = ((EllipsoidalCSRefType) left);
            final EllipsoidalCSRefType rightObject = ((EllipsoidalCSRefType) right);
            {
                EllipsoidalCSType lhsEllipsoidalCS;

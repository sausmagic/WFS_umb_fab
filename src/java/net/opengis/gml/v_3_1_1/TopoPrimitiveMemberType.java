    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der topoPrimitive-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der topoPrimitive-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link NodeType }{@code >}
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractTopoPrimitiveType> theTopoPrimitive;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            JAXBElement<? extends AbstractTopoPrimitiveType> lhsTopoPrimitive;
            lhsTopoPrimitive = this.getTopoPrimitive();
            JAXBElement<? extends AbstractTopoPrimitiveType> rhsTopoPrimitive;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TopoPrimitiveMemberType) {
            ...
            if (this.isSetTopoPrimitive()) {
                JAXBElement<? extends AbstractTopoPrimitiveType> sourceTopoPrimitive;
                sourceTopoPrimitive = this.getTopoPrimitive();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractTopoPrimitiveType> copyTopoPrimitive = ((JAXBElement<? extends AbstractTopoPrimitiveType> ) strategy.copy(LocatorUtils.property(locator, "topoPrimitive", sourceTopoPrimitive), sourceTopoPrimitive));
                copy.setTopoPrimitive(copyTopoPrimitive);
            } else {
                copy.topoPrimitive = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof TopoPrimitiveMemberType) {
            ...
            final TopoPrimitiveMemberType rightObject = ((TopoPrimitiveMemberType) right);
            {
                ...
                target.setTopoPrimitive(((JAXBElement<? extends AbstractTopoPrimitiveType> ) strategy.merge(LocatorUtils.property(leftLocator, "topoPrimitive", lhsTopoPrimitive), LocatorUtils.property(rightLocator, "topoPrimitive", rhsTopoPrimitive), lhsTopoPrimitive, rhsTopoPrimitive)));
            }
            {
                String lhsRemoteSchema;

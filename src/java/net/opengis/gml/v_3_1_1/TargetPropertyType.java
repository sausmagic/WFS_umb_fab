    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TargetPropertyType) {
            ...
            if (this.isSetFeature()) {
                JAXBElement<? extends AbstractFeatureType> sourceFeature;
                sourceFeature = this.getFeature();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractFeatureType> copyFeature = ((JAXBElement<? extends AbstractFeatureType> ) strategy.copy(LocatorUtils.property(locator, "feature", sourceFeature), sourceFeature));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof TargetPropertyType) {
            ...
            final TargetPropertyType rightObject = ((TargetPropertyType) right);
            {
                ...
                target.setFeature(((JAXBElement<? extends AbstractFeatureType> ) strategy.merge(LocatorUtils.property(leftLocator, "feature", lhsFeature), LocatorUtils.property(rightLocator, "feature", rhsFeature), lhsFeature, rhsFeature)));
            }
            {
                JAXBElement<? extends AbstractGeometryType> lhsGeometry;

...
/**
 * <p>Java-Klasse für GraphStylePropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GraphStylePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GraphStylePropertyType that = ((GraphStylePropertyType) object);
        {
            GraphStyleType lhsGraphStyle;
            lhsGraphStyle = this.getGraphStyle();
            GraphStyleType rhsGraphStyle;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof GraphStylePropertyType) {
            final GraphStylePropertyType copy = ((GraphStylePropertyType) draftCopy);
            if (this.isSetGraphStyle()) {
                GraphStyleType sourceGraphStyle;
                sourceGraphStyle = this.getGraphStyle();
                GraphStyleType copyGraphStyle = ((GraphStyleType) strategy.copy(LocatorUtils.property(locator, "graphStyle", sourceGraphStyle), sourceGraphStyle));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof GraphStylePropertyType) {
            final GraphStylePropertyType target = this;
            final GraphStylePropertyType leftObject = ((GraphStylePropertyType) left);
            final GraphStylePropertyType rightObject = ((GraphStylePropertyType) right);
            {
                GraphStyleType lhsGraphStyle;
                lhsGraphStyle = leftObject.getGraphStyle();
                GraphStyleType rhsGraphStyle;
                rhsGraphStyle = rightObject.getGraphStyle();
                target.setGraphStyle(((GraphStyleType) strategy.merge(LocatorUtils.property(leftLocator, "graphStyle", lhsGraphStyle), LocatorUtils.property(rightLocator, "graphStyle", rhsGraphStyle), lhsGraphStyle, rhsGraphStyle)));
            }
            {
                String lhsAbout;

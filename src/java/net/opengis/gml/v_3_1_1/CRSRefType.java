 ...
 * 
 * <p>Java-Klasse für CRSRefType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractReferenceSystemType> theCRS;
            theCRS = this.getCRS();
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CRSRefType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CRSRefType that = ((CRSRefType) object);
        {
            JAXBElement<? extends AbstractReferenceSystemType> lhsCRS;
            lhsCRS = this.getCRS();
            JAXBElement<? extends AbstractReferenceSystemType> rhsCRS;
            rhsCRS = that.getCRS();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CRSRefType) {
            final CRSRefType copy = ((CRSRefType) draftCopy);
            if (this.isSetCRS()) {
                JAXBElement<? extends AbstractReferenceSystemType> sourceCRS;
                sourceCRS = this.getCRS();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractReferenceSystemType> copyCRS = ((JAXBElement<? extends AbstractReferenceSystemType> ) strategy.copy(LocatorUtils.property(locator, "crs", sourceCRS), sourceCRS));
                copy.setCRS(copyCRS);
            } else {
                copy.crs = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof CRSRefType) {
            final CRSRefType target = this;
            final CRSRefType leftObject = ((CRSRefType) left);
            final CRSRefType rightObject = ((CRSRefType) right);
            {
                JAXBElement<? extends AbstractReferenceSystemType> lhsCRS;
                lhsCRS = leftObject.getCRS();
                JAXBElement<? extends AbstractReferenceSystemType> rhsCRS;
                rhsCRS = rightObject.getCRS();
                target.setCRS(((JAXBElement<? extends AbstractReferenceSystemType> ) strategy.merge(LocatorUtils.property(leftLocator, "crs", lhsCRS), LocatorUtils.property(rightLocator, "crs", rhsCRS), lhsCRS, rhsCRS)));
            }
            {
                String lhsRemoteSchema;

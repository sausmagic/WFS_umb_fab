 ...
 * 
 * <p>Java-Klasse für ProjectedCRSRefType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ProjectedCRSRefType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ProjectedCRSRefType that = ((ProjectedCRSRefType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof ProjectedCRSRefType) {
            final ProjectedCRSRefType copy = ((ProjectedCRSRefType) draftCopy);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof ProjectedCRSRefType) {
            final ProjectedCRSRefType target = this;
            final ProjectedCRSRefType leftObject = ((ProjectedCRSRefType) left);
            final ProjectedCRSRefType rightObject = ((ProjectedCRSRefType) right);
            {
                ProjectedCRSType lhsProjectedCRS;

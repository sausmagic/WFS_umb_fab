 ...
 * 
 * <p>Java-Klasse für ReferenceSystemRefType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der referenceSystem-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractReferenceSystemType> theReferenceSystem;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ReferenceSystemRefType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ReferenceSystemRefType that = ((ReferenceSystemRefType) object);
        {
            JAXBElement<? extends AbstractReferenceSystemType> lhsReferenceSystem;
            lhsReferenceSystem = this.getReferenceSystem();
            JAXBElement<? extends AbstractReferenceSystemType> rhsReferenceSystem;
            rhsReferenceSystem = that.getReferenceSystem();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "referenceSystem", lhsReferenceSystem), LocatorUtils.property(thatLocator, "referenceSystem", rhsReferenceSystem), lhsReferenceSystem, rhsReferenceSystem)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractReferenceSystemType> theReferenceSystem;
            theReferenceSystem = this.getReferenceSystem();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "referenceSystem", theReferenceSystem), currentHashCode, theReferenceSystem);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof ReferenceSystemRefType) {
            final ReferenceSystemRefType copy = ((ReferenceSystemRefType) draftCopy);
            if (this.isSetReferenceSystem()) {
                JAXBElement<? extends AbstractReferenceSystemType> sourceReferenceSystem;
                sourceReferenceSystem = this.getReferenceSystem();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractReferenceSystemType> copyReferenceSystem = ((JAXBElement<? extends AbstractReferenceSystemType> ) strategy.copy(LocatorUtils.property(locator, "referenceSystem", sourceReferenceSystem), sourceReferenceSystem));
                copy.setReferenceSystem(copyReferenceSystem);
            } else {
                copy.referenceSystem = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof ReferenceSystemRefType) {
            final ReferenceSystemRefType target = this;
            final ReferenceSystemRefType leftObject = ((ReferenceSystemRefType) left);
            final ReferenceSystemRefType rightObject = ((ReferenceSystemRefType) right);
            {
                JAXBElement<? extends AbstractReferenceSystemType> lhsReferenceSystem;
                lhsReferenceSystem = leftObject.getReferenceSystem();
                JAXBElement<? extends AbstractReferenceSystemType> rhsReferenceSystem;
                rhsReferenceSystem = rightObject.getReferenceSystem();
                target.setReferenceSystem(((JAXBElement<? extends AbstractReferenceSystemType> ) strategy.merge(LocatorUtils.property(leftLocator, "referenceSystem", lhsReferenceSystem), LocatorUtils.property(rightLocator, "referenceSystem", rhsReferenceSystem), lhsReferenceSystem, rhsReferenceSystem)));
            }
            {
                String lhsRemoteSchema;

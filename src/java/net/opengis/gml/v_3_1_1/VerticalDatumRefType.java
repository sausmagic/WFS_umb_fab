 ...
 * 
 * <p>Java-Klasse für VerticalDatumRefType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof VerticalDatumRefType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final VerticalDatumRefType that = ((VerticalDatumRefType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof VerticalDatumRefType) {
            final VerticalDatumRefType copy = ((VerticalDatumRefType) draftCopy);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof VerticalDatumRefType) {
            final VerticalDatumRefType target = this;
            final VerticalDatumRefType leftObject = ((VerticalDatumRefType) left);
            final VerticalDatumRefType rightObject = ((VerticalDatumRefType) right);
            {
                VerticalDatumType lhsVerticalDatum;

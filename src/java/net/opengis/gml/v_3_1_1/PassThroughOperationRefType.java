 ...
 * 
 * <p>Java-Klasse für PassThroughOperationRefType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof PassThroughOperationRefType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final PassThroughOperationRefType that = ((PassThroughOperationRefType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof PassThroughOperationRefType) {
            final PassThroughOperationRefType copy = ((PassThroughOperationRefType) draftCopy);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof PassThroughOperationRefType) {
            final PassThroughOperationRefType target = this;
            final PassThroughOperationRefType leftObject = ((PassThroughOperationRefType) left);
            final PassThroughOperationRefType rightObject = ((PassThroughOperationRefType) right);
            {
                PassThroughOperationType lhsPassThroughOperation;

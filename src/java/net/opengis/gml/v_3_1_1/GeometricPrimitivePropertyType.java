    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der geometricPrimitive-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der geometricPrimitive-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link TriangulatedSurfaceType }{@code >}
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractGeometricPrimitiveType> theGeometricPrimitive;
            theGeometricPrimitive = this.getGeometricPrimitive();
            strategy.appendField(locator, this, "geometricPrimitive", buffer, theGeometricPrimitive);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            JAXBElement<? extends AbstractGeometricPrimitiveType> lhsGeometricPrimitive;
            lhsGeometricPrimitive = this.getGeometricPrimitive();
            JAXBElement<? extends AbstractGeometricPrimitiveType> rhsGeometricPrimitive;
            rhsGeometricPrimitive = that.getGeometricPrimitive();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "geometricPrimitive", lhsGeometricPrimitive), LocatorUtils.property(thatLocator, "geometricPrimitive", rhsGeometricPrimitive), lhsGeometricPrimitive, rhsGeometricPrimitive)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractGeometricPrimitiveType> theGeometricPrimitive;
            theGeometricPrimitive = this.getGeometricPrimitive();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "geometricPrimitive", theGeometricPrimitive), currentHashCode, theGeometricPrimitive);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof GeometricPrimitivePropertyType) {
            ...
            if (this.isSetGeometricPrimitive()) {
                JAXBElement<? extends AbstractGeometricPrimitiveType> sourceGeometricPrimitive;
                sourceGeometricPrimitive = this.getGeometricPrimitive();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractGeometricPrimitiveType> copyGeometricPrimitive = ((JAXBElement<? extends AbstractGeometricPrimitiveType> ) strategy.copy(LocatorUtils.property(locator, "geometricPrimitive", sourceGeometricPrimitive), sourceGeometricPrimitive));
                copy.setGeometricPrimitive(copyGeometricPrimitive);
            } else {
                copy.geometricPrimitive = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof GeometricPrimitivePropertyType) {
            ...
            {
                JAXBElement<? extends AbstractGeometricPrimitiveType> lhsGeometricPrimitive;
                lhsGeometricPrimitive = leftObject.getGeometricPrimitive();
                JAXBElement<? extends AbstractGeometricPrimitiveType> rhsGeometricPrimitive;
                rhsGeometricPrimitive = rightObject.getGeometricPrimitive();
                target.setGeometricPrimitive(((JAXBElement<? extends AbstractGeometricPrimitiveType> ) strategy.merge(LocatorUtils.property(leftLocator, "geometricPrimitive", lhsGeometricPrimitive), LocatorUtils.property(rightLocator, "geometricPrimitive", rhsGeometricPrimitive), lhsGeometricPrimitive, rhsGeometricPrimitive)));
            }
            {
                String lhsRemoteSchema;

...
/**
 * <p>Java-Klasse für TimeGeometricPrimitivePropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der timeGeometricPrimitive-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der timeGeometricPrimitive-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link TimeInstantType }{@code >}
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractTimeGeometricPrimitiveType> theTimeGeometricPrimitive;
            theTimeGeometricPrimitive = this.getTimeGeometricPrimitive();
            strategy.appendField(locator, this, "timeGeometricPrimitive", buffer, theTimeGeometricPrimitive);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            JAXBElement<? extends AbstractTimeGeometricPrimitiveType> lhsTimeGeometricPrimitive;
            lhsTimeGeometricPrimitive = this.getTimeGeometricPrimitive();
            JAXBElement<? extends AbstractTimeGeometricPrimitiveType> rhsTimeGeometricPrimitive;
            rhsTimeGeometricPrimitive = that.getTimeGeometricPrimitive();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "timeGeometricPrimitive", lhsTimeGeometricPrimitive), LocatorUtils.property(thatLocator, "timeGeometricPrimitive", rhsTimeGeometricPrimitive), lhsTimeGeometricPrimitive, rhsTimeGeometricPrimitive)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractTimeGeometricPrimitiveType> theTimeGeometricPrimitive;
            theTimeGeometricPrimitive = this.getTimeGeometricPrimitive();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "timeGeometricPrimitive", theTimeGeometricPrimitive), currentHashCode, theTimeGeometricPrimitive);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TimeGeometricPrimitivePropertyType) {
            final TimeGeometricPrimitivePropertyType copy = ((TimeGeometricPrimitivePropertyType) draftCopy);
            if (this.isSetTimeGeometricPrimitive()) {
                JAXBElement<? extends AbstractTimeGeometricPrimitiveType> sourceTimeGeometricPrimitive;
                sourceTimeGeometricPrimitive = this.getTimeGeometricPrimitive();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractTimeGeometricPrimitiveType> copyTimeGeometricPrimitive = ((JAXBElement<? extends AbstractTimeGeometricPrimitiveType> ) strategy.copy(LocatorUtils.property(locator, "timeGeometricPrimitive", sourceTimeGeometricPrimitive), sourceTimeGeometricPrimitive));
                copy.setTimeGeometricPrimitive(copyTimeGeometricPrimitive);
            } else {
                copy.timeGeometricPrimitive = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof TimeGeometricPrimitivePropertyType) {
            final TimeGeometricPrimitivePropertyType target = this;
            final TimeGeometricPrimitivePropertyType leftObject = ((TimeGeometricPrimitivePropertyType) left);
            final TimeGeometricPrimitivePropertyType rightObject = ((TimeGeometricPrimitivePropertyType) right);
            {
                JAXBElement<? extends AbstractTimeGeometricPrimitiveType> lhsTimeGeometricPrimitive;
                lhsTimeGeometricPrimitive = leftObject.getTimeGeometricPrimitive();
                JAXBElement<? extends AbstractTimeGeometricPrimitiveType> rhsTimeGeometricPrimitive;
                rhsTimeGeometricPrimitive = rightObject.getTimeGeometricPrimitive();
                target.setTimeGeometricPrimitive(((JAXBElement<? extends AbstractTimeGeometricPrimitiveType> ) strategy.merge(LocatorUtils.property(leftLocator, "timeGeometricPrimitive", lhsTimeGeometricPrimitive), LocatorUtils.property(rightLocator, "timeGeometricPrimitive", rhsTimeGeometricPrimitive), lhsTimeGeometricPrimitive, rhsTimeGeometricPrimitive)));
            }
            {
                String lhsRemoteSchema;

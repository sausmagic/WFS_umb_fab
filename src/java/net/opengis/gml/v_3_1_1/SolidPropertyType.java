    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            JAXBElement<? extends AbstractSolidType> lhsSolid;
            lhsSolid = this.getSolid();
            JAXBElement<? extends AbstractSolidType> rhsSolid;
            rhsSolid = that.getSolid();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "solid", lhsSolid), LocatorUtils.property(thatLocator, "solid", rhsSolid), lhsSolid, rhsSolid)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractSolidType> theSolid;
            theSolid = this.getSolid();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "solid", theSolid), currentHashCode, theSolid);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof SolidPropertyType) {
            ...
            if (this.isSetSolid()) {
                JAXBElement<? extends AbstractSolidType> sourceSolid;
                sourceSolid = this.getSolid();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractSolidType> copySolid = ((JAXBElement<? extends AbstractSolidType> ) strategy.copy(LocatorUtils.property(locator, "solid", sourceSolid), sourceSolid));
                copy.setSolid(copySolid);
            } else {
                copy.solid = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof SolidPropertyType) {
            ...
            {
                JAXBElement<? extends AbstractSolidType> lhsSolid;
                lhsSolid = leftObject.getSolid();
                JAXBElement<? extends AbstractSolidType> rhsSolid;
                rhsSolid = rightObject.getSolid();
                target.setSolid(((JAXBElement<? extends AbstractSolidType> ) strategy.merge(LocatorUtils.property(leftLocator, "solid", lhsSolid), LocatorUtils.property(rightLocator, "solid", rhsSolid), lhsSolid, rhsSolid)));
            }
            {
                String lhsRemoteSchema;

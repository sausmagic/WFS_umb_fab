    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        ...
        if (right instanceof ParameterValueType) {
            ...
            }
            {
                ...
                target.setBooleanValue(((Boolean) strategy.merge(LocatorUtils.property(leftLocator, "booleanValue", lhsBooleanValue), LocatorUtils.property(rightLocator, "booleanValue", rhsBooleanValue), lhsBooleanValue, rhsBooleanValue)));
            }
            {
                MeasureListType lhsValueList;
            ...
            }
            {
                ...
                target.setValueOfParameter(((OperationParameterRefType) strategy.merge(LocatorUtils.property(leftLocator, "valueOfParameter", lhsValueOfParameter), LocatorUtils.property(rightLocator, "valueOfParameter", rhsValueOfParameter), lhsValueOfParameter, rhsValueOfParameter)));
            }
        }
    }

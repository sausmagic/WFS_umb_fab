 ...
 * 
 * <p>Java-Klasse für OperationParameterRefType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof OperationParameterRefType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final OperationParameterRefType that = ((OperationParameterRefType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof OperationParameterRefType) {
            final OperationParameterRefType copy = ((OperationParameterRefType) draftCopy);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof OperationParameterRefType) {
            final OperationParameterRefType target = this;
            final OperationParameterRefType leftObject = ((OperationParameterRefType) left);
            final OperationParameterRefType rightObject = ((OperationParameterRefType) right);
            {
                OperationParameterType lhsOperationParameter;

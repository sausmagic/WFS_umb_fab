 ...
 * 
 * <p>Java-Klasse für ImageCRSRefType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ImageCRSRefType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ImageCRSRefType that = ((ImageCRSRefType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof ImageCRSRefType) {
            final ImageCRSRefType copy = ((ImageCRSRefType) draftCopy);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof ImageCRSRefType) {
            final ImageCRSRefType target = this;
            final ImageCRSRefType leftObject = ((ImageCRSRefType) left);
            final ImageCRSRefType rightObject = ((ImageCRSRefType) right);
            {
                ImageCRSType lhsImageCRS;

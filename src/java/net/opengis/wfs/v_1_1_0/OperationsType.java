    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof OperationsType) {
            ...
            if ((this.operation!= null)&&(!this.operation.isEmpty())) {
                ...
                List<OperationType> copyOperation = ((List<OperationType> ) strategy.copy(LocatorUtils.property(locator, "operation", sourceOperation), sourceOperation));
                copy.operation = null;
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof OperationsType) {
            ...
            final OperationsType rightObject = ((OperationsType) right);
            {
                ...
                uniqueOperationl.addAll(((List<OperationType> ) strategy.merge(LocatorUtils.property(leftLocator, "operation", lhsOperation), LocatorUtils.property(rightLocator, "operation", rhsOperation), lhsOperation, rhsOperation)));
            }
        }
    }

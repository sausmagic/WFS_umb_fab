 ...
 *          
 * 
 * <p>Java-Klasse für TransactionResultsType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TransactionResultsType) {
            ...
            if ((this.action!= null)&&(!this.action.isEmpty())) {
                ...
                List<ActionType> copyAction = ((List<ActionType> ) strategy.copy(LocatorUtils.property(locator, "action", sourceAction), sourceAction));
                copy.action = null;
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof TransactionResultsType) {
            ...
            {
                List<ActionType> lhsAction;
                lhsAction = leftObject.getAction();
                List<ActionType> rhsAction;
                rhsAction = rightObject.getAction();
                target.action = null;
                List<ActionType> uniqueActionl = target.getAction();
                uniqueActionl.addAll(((List<ActionType> ) strategy.merge(LocatorUtils.property(leftLocator, "action", lhsAction), LocatorUtils.property(rightLocator, "action", rhsAction), lhsAction, rhsAction)));
            }
        }
    }
